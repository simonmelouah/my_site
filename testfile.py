...
cov = coverage(branch=True, omit=['flask/*', 'models.py', 'testfile.py', 'forms.py', 'logins.py', 'configue_aws_instance.py', 'db_interaction.py', 'decorator.py', 'hotel_voucher_validation.py', 'mail_pdf.py', 'password_encrypt.py','/Library/Python/2.7/*'])
cov.start()
